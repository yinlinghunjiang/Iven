...
class Tailapi:
    ...
    def getFursuitRand(self):
        ...
        resp = http.request(
            "GET",
            "https://api.tail.icu/api/v2/getFursuitRand?qq={}&timestamp={}&sign={}".format(
                sign[1], str(ts), prsign
            ),
        )  # get方式请求
    ...
    def getFursuitByName(self, name):
        ...
        resp = http.request(
            "GET",
            "https://api.tail.icu/api/v2/getFursuitByName?qq={}&timestamp={}&sign={}&name={}".format(
                sign[1], str(ts), prsign, name
            ),
        )
        text = json.loads(resp._body)
        return text
    ...
    def getFursuitByID(self, furid):
        ...
        resp = http.request(
            "GET",
            "https://api.tail.icu/api/v2/getFursuitByID?qq={}&timestamp={}&sign={}&fid={}".format(
                sign[1], str(ts), prsign, furid
            ),
        )
        text = json.loads(resp._body)
        return text
    ...
    def getDaliyFursuitRand(self):
        ...
        resp = http.request(
            "GET",
            "https://api.tail.icu/api/v2/DailyFursuit/Rand?qq={}&timestamp={}&sign={}".format(
                sign[1], str(ts), prsign
            ),
        )
        text = json.loads(resp._body)
    ...
    def getDaliyFursuitByID(self, dayid):
        ...
        resp = http.request(
            "GET",
            "https://api.tail.icu/api/v2/DailyFursuit/id?qq={}&timestamp={}&sign={}&id={}".format(
                sign[1], str(ts), prsign, dayid
            ),
        )
        text = json.loads(resp._body)
        return text
    ...
    def getDaliyFursuitByName(self, name):
        ...
        resp = http.request(
            "GET",
            "https://api.tail.icu/api/v2/DailyFursuit/name?qq={}&timestamp={}&sign={}&name={}".format(
                sign[1], str(ts), prsign, name
            ),
        )
        text = json.loads(resp._body)
